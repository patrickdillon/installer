...
func (c *Cluster) Generate(dependencies asset.Parents) error {
	...
	c.FileList = append(c.FileList, &asset.ManifestFile{Object: namespace, File: asset.File{Filename: "00_capi-namespace.yaml"}})
	...
	c.FileList = append(c.FileList, &asset.ManifestFile{Object: cluster, File: asset.File{Filename: "01_capi-cluster.yaml"}})
...
func (c *Cluster) ManifestFiles() []*asset.ManifestFile {
	return c.FileList
}
...
func (c *Cluster) Load(f asset.FileFetcher) (bool, error) {
	...
	for _, file := range fileList {
		...
		c.FileList = append(c.FileList, &asset.ManifestFile{
			File: asset.File{
