...
// ControlPlaneNetworkSecurityGroupName returns the name of the NSG for the
// control plane subnet.
func (p *Platform) ControlPlaneNetworkSecurityGroupName(infraID string) string {
	return fmt.Sprintf("%s-controlplane-nsg", infraID)
}

// ComputeNetworkSecurityGroupName returns the name of the NSG for the compute
// subnet.
func (p *Platform) ComputeNetworkSecurityGroupName(infraID string) string {
	return fmt.Sprintf("%s-node-nsg", infraID)
}
