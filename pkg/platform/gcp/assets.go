...
// CloudProviderConfig provides the cloud provider config file for Amazon Web Services.
func (g *GCP) CloudProviderConfig(infraID, clusterName string) (string, error) {
	gcpConfig, err := CloudProviderConfig(infraID, g.ProjectID)
	if err != nil {
