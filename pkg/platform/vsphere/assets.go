...
// CloudProviderConfig provides the cloud provider config file for VSphere
func (v *VSphere) CloudProviderConfig(infraID, clusterName string) (string, error) {
	vsphereConfig, err := CloudProviderConfig(clusterName, &v.Platform)
