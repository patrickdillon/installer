...
// CloudProviderConfig provides the cloud provider config file for OpenStack
func (o *OpenStack) CloudProviderConfig(infraID, clusterName string) (string, error) {
	...
	return CloudProviderConfig(cloud), nil
}
